...
if(isset($_POST['skills']) && !empty($_POST['skills']) && !preg_match('~^\w+(, \w+)*$~', $_POST['skills']))
{
...
if(isset($_POST['title']) && isset($_POST['cost']) && isset($_POST['category']) && isset($_POST['skills']) && isset($_POST['description']))
{


    if(!empty($_POST['title']) && !empty($_POST['cost']) && !empty($_POST['category']) && !empty($_POST['skills']) && !empty($_POST['description']))
    {
        $stmt = $pdo->prepare("INSERT INTO post(client_id, title, description, cost, category, status, paid_status, start_date, skills) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$_SESSION['id'], $_POST['title'], $_POST['description'], $_POST['cost'], $_POST['category'], "available", false, date("Y-m-d H:i:s"), $_POST['skills']]);
        ...
        <div class="container">
            ...
            <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
                ...
                <div class="logo-wrapper">
                    <a href="BrowseFreelancers.php"><img src="img/icons/ACoding.png" alt=""></a>
                </div>
                <!-- Page Title-->
                <div class="page-heading">
                    <h6 class="mb-0">Publishing Post</h6>
                </div>
                <!-- Navbar Toggler-->
                ...
                <div class="card-body">
                    ...
                    <div class="contact-form">
                        <form action="" method="post">
                            ...
                            <div class="form-group mb-3">
                                <input class="form-control" type="text" placeholder="Skills" name="skills">
                            </div>
        ...
        <div class="container px-0">
            ...
            <div class="footer-nav position-relative">
                <ul class="h-100 d-flex align-items-center justify-content-between ps-0">
                    <li><a href="BrowseFreelancers.php"><svg width="20" height="20" viewBox="0 0 16 16" class="bi bi-house" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
<path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
</svg><span>Home</span></a></li>
                    <li class="active"><a href="publishPost.php"><svg width="20" height="20" viewBox="0 0 16 16" class="bi bi-collection" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" d="M14.5 13.5h-13A.5.5 0 0 1 1 13V6a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5zm-13 1A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5h-13zM2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3zm2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1z"/>
