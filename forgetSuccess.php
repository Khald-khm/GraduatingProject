...
if(!isset($_COOKIE['VerifyCode']))
{
    ...
    setcookie('VerifyCode', $random, time() + (86400 * 30), "/");
}
...
$to_email = $email;
$subject = "Get Job Verify Code";
$body = "Your Verify Code is " . $_COOKIE['VerifyCode'];
$headers = "From:mohamadkhald2001.2@gmail.com";

if (!mail($to_email, $subject, $body, $headers)) 
{
    header('location: forgetFailed.php');
} 
...
<head>
    ...
    <!-- Title-->
    <title>page-forget-password-success</title>
    <!-- Fonts-->
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
                    <div class="text-center px-4"><img class="login-intro-img mb-4" src="img/bg-img/38.png" alt="">
                        ...
                        <!-- Go Back Button--><a class="btn btn-primary" href="resetPassword.php">Reset Password</a>
                    </div>
                </div>
            </div>
        </div>
