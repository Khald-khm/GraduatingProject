...
if($_SESSION['group_id'] == 2){
    $stmt = $pdo->prepare('SELECT * FROM post WHERE client_id = ? AND status != "done" AND status != "pay" AND paid_status = true');
        ...
        <div class="container">
            ...
            <div class="card product-details-card mb-3 direction-rtl">
                <div class="card-body">
                    ...
                    <h6><a href="profile.php?id=<?php echo $row['freelancer_id']; ?>"> Freelancer ID = <?php echo $row['freelancer_id']; ?></a></h6></br>
                    <h3><?php echo $row['title']; ?></h3>
                    <h1>$<?php echo $row['cost']; ?></h1>
                    <!-- <a href="#" class="blog-author mr-3">Mark Wilson</a> -->
                    ...
                    <div>
                        ...
                        ?>
                            ...
                            <div class="d-flex align-items-center justify-content-between pt-3">
                                <h5><?php echo $fetch['storage_name']?></h5>

                                <!-- <button class="btn btn-primary w-10" type="submit"> Download</button> -->

                                <a href="download.php?file_id=<?php echo $fetch['id']?>" class="btn btn-primary">Download</a></td>
                            </div>
                    ...
                    <div class="mar d-flex align-items-center justify-content-around">
                        <a href="doneClient.php?post_id=<?php echo $row['id']; ?>" class="btn btn-primary w-50">Done</a>
                    </div>
...
<path fill-rule="evenodd" d="M14.5 13.5h-13A.5.5 0 0 1 1 13V6a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5zm-13 1A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5h-13zM2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3zm2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1z"/>
                    ...
                    <li class="active"><a href="manageProjectClient.php"><svg width="20" height="20" viewBox="0 0 16 16" class="bi bi-folder2-open" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
