...
{
    $stmt = $pdo->prepare("SELECT id, email, group_id FROM user WHERE username = ?");
    ...
    if($stmt->rowcount() == 1)
    {
        ...
        header("location: forgetSuccess.php");
                ...
                <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
                    ...
                    <div class="register-form mt-4 px-4">
                        <form action="" method="get">
                            ...
                            <button class="btn btn-primary w-100" type="submit">Send Me a Verify Code</button>
                        </form>
                    </div>
                </div>
            </div>
