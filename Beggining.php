...
<body>
    ...
    <div class="hero-block-wrapper bg-primary">
        ...
        <div class="container">
            <!-- Skip Page-->
            <div class="skip-page"><a href="login.php">Skip</a></div>
            <!-- Hero Block Content-->
            <div class="hero-block-content"><img class="mb-4" src="img/bg-img/19.png" alt="">
                <h2 class="display-4 text-white mb-3">Join the world's work marketplace
                </h2>
                <p class="text-white">Find great talent. Build your business. Take your career to the next level.</p>
