...
// user id should be in the link of his username

$stmt = $pdo->prepare("SELECT username, post.id, title, post.description, cost, post.start_date, post.skills, status FROM post, user WHERE client_id = user.id AND paid_status = false");
// if user choose from links aside
if(isset($_POST['link']))
{
    $link = $_POST['link'];

    $stmt = $pdo->prepare("SELECT username, post.id, title, post.description, cost, post.start_date, post.skills, status FROM post, user WHERE client_id = user.id AND paid_status = false AND CONCAT(post.id) LIKE '%$link%' ");
}
...
<body>
    ...
    <path fill-rule="evenodd" d="M14.5 13.5h-13A.5.5 0 0 1 1 13V6a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5zm-13 1A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5h-13zM2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3zm2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1z"/>
            ...
            <li >
                <a href="manageProjectsCompany.php">
    ...
    <div class="page-content-wrapper py-3">
        ...
        <div class="container">
                ...
                <div class="card-body p-2">
                    <div class="chat-search-box">
                        <form action="" method="post">
                            ...
                            <input class="form-control" type="search" placeholder="Search by post id" aria-describedby="searchbox" name="link">
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="card product-details-card mb-3 direction-rtl mt-2">
                <div class="card-body">
                    <p> Post ID = <?php echo $row['id'];?></p>
                    <h3><?php echo $row['title'];?></h3>
                    <h1>$<?php echo $row['cost'];?></h1>
                    <div class="input-group">
                        <h6><a href="profile.php?id=" class="blog-author mr-3"><?php echo $row['username'];?></a></h6>
                    </div>
                    

                    <div class="mar">
                    
                        <a href="paidPost.php?post_id=<?php echo $row['id']; ?>" class="btn btn-primary w-10" type="submit"> Paid </a>
                    </div>
...
<path fill-rule="evenodd" d="M14.5 13.5h-13A.5.5 0 0 1 1 13V6a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5zm-13 1A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5h-13zM2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3zm2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1z"/>
                    ...
                    <li><a href="manageProjectsCompany.php"><svg width="20" height="20" viewBox="0 0 16 16" class="bi bi-folder2-open" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
