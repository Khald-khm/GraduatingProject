...
if(isset($_GET['link']))
{
    ...
    $stmt = $db->prepare("SELECT username, post.id, title, post.description, cost, post.start_date, post.skills, status, paid_status FROM post, user WHERE client_id = user.id AND lower(category) =lower('$link') AND paid_status = false");
}
        ...
        <div class="container">
            ...
            <div class="card product-details-card mb-3 direction-rtl">
                <div class="card-body">
                    ...
                    <a href="#" class="blog-author mr-3"><?php echo $row['username'];?></a>
                    

                    <div class="input-group">
                    
                        <a href="paidPost.php?post_id=<?php echo $row['id']; ?>" class="btn btn-primary w-50" type="submit"> Paid </a>
                    </div>
                    </form>
                </div>
            </div>
