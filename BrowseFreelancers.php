        ...
        <div class="container">
            ...
            <div class="card product-details-card mb-3 direction-rtl">
                <div class="card-body">
                    ...
                    <a href="#" class="blog-author mr-3"><i class="far fa-user mr-2"></i><?php echo $row['first_name'] . " " . $row['last_name'];?></a>
                    <p> 
                    ...
                    <div class="input-group">
                        ...
                        <a href="chat.php?<?php echo "id=".$row['id'];?> " class="btn btn-primary w-50" type="submit">Text me</a>
                    </div>
                </div>
            </div>
...
<path fill-rule="evenodd" d="M14.5 13.5h-13A.5.5 0 0 1 1 13V6a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5zm-13 1A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5h-13zM2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3zm2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1z"/>
                    ...
                    <li><a href="manageProjects.php"><svg width="20" height="20" viewBox="0 0 16 16" class="bi bi-folder2-open" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
