...
// don't forget to add skill and bio to query

$stmt = $pdo->prepare("SELECT paid_status FROM post WHERE client_id = ? LIMIT 1");
$stmt->execute([$_SESSION['id']]);
$paying = $stmt->fetch();

$pay = $paying['paid_status'];
...
// in the loop user_id = $row['id']
// // to show every rate for every user
// $stmt = $db->prepare('SELECT AVG(rated) FROM rate, user WHERE user_id = $row['id'];')
// $stmt->execute(); 
...
<body>
        ...
        <div class="container">
            ...
            <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
                ...
                <div class="page-heading">
                    <h6 class="mb-0">Browse Freelancers</h6>
                </div>
                <!-- Navbar Toggler-->
    ...
    <div class="page-content-wrapper py-3" style="">
        ...
        <!-- style="margin-left: 20vw; height: 100%; display: flex; justify-content: space-around; flex-wrap: wrap; padding: 50px;" -->
            ...
            <div class="card product-details-card mb-3 direction-rtl">
                <div class="card-body">
                    ...
                    <h1>$<?php echo $row['hourly_rate'];?> /hr</h1>
                    <a href="profile.php?id=<?php echo $row['id']; ?>" class="blog-author mr-3"><i class="far fa-user mr-2"></i><?php echo $row['first_name'] . " " . $row['last_name'];?></a>
                    <p> 
            ...
            <!-- <div class="cardContainer">
                ...
                <div class="product-detail">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint nesciunt beatae 
                        molestiae asperiores voluptas commodi dicta doloribus minus at eos 
                        ducimus dignissimos, impedit ipsum id optio! Rem animi architecto earum.
                    </p>
                    ...
                    <div class="buttons">
                        <span class="price">$ 10/hr</span>
                        <a href="profile.php"> <button class="btn cart">View Profile</button> </a>
                        <button href="chat.php" class="btn bookmark"> <img src="../plugins/chat_icon.svg" alt="chat"> </button>
                    </div>
